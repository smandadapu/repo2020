...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="GetClientCode">
		<xsl:choose>
			<xsl:when test="REQUESTCODE = 'MINRTOVRADDRq' or REQUESTCODE = 'MINRTOVRINQRq' or REQUESTCODE = 'MINRTOVRCHGRq' or REQUESTCODE = 'MINRTOVRDFTRq'  or REQUESTCODE = 'BASFACMPADDRq' or REQUESTCODE = 'WCVATCMTDLTRq' or REQUESTCODE = 'GLEXTCYCRUNRq'">
